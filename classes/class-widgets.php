	...
	function form( $instance ) {
		...
		if ( ! empty( $available_calendars ) ) : 
			...
			<p>
	            ...
	            <input type="checkbox" value="all" name="<?php echo $this->get_field_name('calendars' . $ft_array_spec); ?>" id="<?php echo $this->get_field_id( 'all' ); ?>" <?php checked( in_array( 'all', $checked_calendars ) ) ?> class="checkbox" />
                <label for="<?php echo $this->get_field_id( 'all' ); ?>"><?php _e( 'All Calendars', 'ftcalendar' ); ?></label>
				<?php foreach ( (array)$available_calendars as $key => $calendar ) : ?>
	                <br />
	                <input type="checkbox" value="<?php echo $calendar->slug; ?>" name="<?php echo $this->get_field_name('calendars' . $ft_array_spec); ?>" id="<?php echo $this->get_field_id( $calendar->slug ); ?>" <?php checked( in_array( $calendar->slug, $checked_calendars ) ) ?> class="checkbox" /> 
